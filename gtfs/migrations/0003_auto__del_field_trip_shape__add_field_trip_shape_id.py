...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Trip.shape'
        db.delete_column('gtfs_trip', 'shape_id')

        # Adding field 'Trip.shape_id'
        db.add_column('gtfs_trip', 'shape_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Trip.shape'
        db.add_column('gtfs_trip', 'shape', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gtfs.Shape'], null=True, blank=True), keep_default=False)

        # Deleting field 'Trip.shape_id'
        db.delete_column('gtfs_trip', 'shape_id')
